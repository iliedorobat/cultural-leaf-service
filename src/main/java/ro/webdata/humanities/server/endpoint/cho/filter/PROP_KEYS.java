...
public class PROP_KEYS {
    public static final String AGENT_COUNTY = "agentCounty";
    ...
    public static final String NATURE_AGE = "natureAge";
    public static final String NATURE_EPOCH = "natureEpoch";
    public static final String NATURE_SEX = "natureSex";
